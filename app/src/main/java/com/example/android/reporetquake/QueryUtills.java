...
import static com.example.android.reporetquake.EarthQuakeActivity.LOG_TAG;
import static com.example.android.reporetquake.EarthQuakeLoader.TAG;
...
public final class QueryUtills {
     ...
     */
    public static ArrayList<EarthQuake> extractEarthquakes(String urlStr) {
        ...
        try {
            ...
            Log.i(ContentValues.TAG, "extractEarthquakes: url=" + urlStr);
            URL url1 = createUrl(urlStr);
            String jsonStr = makeHttpRequest(url1);
            //Log.i(TAG, "extractEarthquakes: jsonStr=" + jsonStr);
            ...
            Log.i(ContentValues.TAG, "extractEarthquakes: items->" + earthquakes.size());
